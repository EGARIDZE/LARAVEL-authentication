...
<main class="flex flex-col justify-center p-6 pb-12">
    ...
    <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
        ...
        <form action="{{route('password.update')}}" method="post" novalidate autocomplete="off" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="email" id="email" name="email" value="{{old('email', $request->email)}}" required class="w-full rounded-md pl-10 text-sm  {{$errors->has('email') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300  focus:border-green-500 focus:ring-green-500'}}" placeholder="john@example.com" />
                    @error('email')
